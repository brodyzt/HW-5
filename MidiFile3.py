...
# modified by GOB on 2013/07/30 at 5:35pm to run with Python 3.3.x by fixing
# the struct.pack calls to behave consistently on bytes
#-----------------------------------------------------------------------------
...
class MIDITrack:
    ...
    def removeDuplicates(self):
        ...
        because the MIDI event stream can become confused otherwise.
        '''
    ...
    def writeEventsToStream(self):
        ...
        for event in self.MIDIEventList:
            if event.type == "NoteOn":
                ...
                self.MIDIdata = self.MIDIdata + struct.pack('>B',event.parameter1)
...
class MIDIFile:
    ...
    def addControllerEvent(self, track, channel, time, eventType, parameter1):
        """
        ...
        """
        self.tracks[track].addControllerEvent(channel, time, eventType, parameter1)
